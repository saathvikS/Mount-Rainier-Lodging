...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: BPdr9UnkUGcde/css
...
function PlasmicTextInput__RenderFunc(props: {
  ...
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          placeholder: "Check-in Date" as const
        },
        props.args
      ),
    [props.args]
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__pVl5T)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___5243J)}
                role={"img"}
              />
            ),
